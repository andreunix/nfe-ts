...
import { buildMdfeXml, loadCertificate, signMdfeXml, validateMdfeXml, type MdfeBuildData } from "../src/fiscal/index.ts";
...
const data: MdfeBuildData = {
  ...
  inf_doc: {
    inf_mun_descarga: [{
      c_mun: "4205407",
      x_mun: "Florianopolis",
      inf_nfe: ["43260312345678000190550010000001231123456780"],
    }],
  },
  tot: {
    q_nfe: 1,
...
const signedXml = signMdfeXml(xml, cert.private_key, cert.certificate);
validateMdfeXml(signedXml);

console.log("MDF-e XML:", xml);
console.log("MDF-e assinado:", signedXml);
